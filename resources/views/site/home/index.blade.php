  ...
  <div class="container pb-5">
    <div class="row gap-2">
      <div class="col-sm order-sm-2">
        <img
          src="{{ asset('site/images/banner.jpg') }}"
      ...
      <div class="col-sm order-sm-1">
        ...
        <p>
          ...
          nesciunt repellendus itaque, laborum saepe enim maxime,
  ...
  <div class="d-flex flex-wrap gap-4 justify-content-center">
    <div class="card p-2" style="width: 18rem">
      <img
        ...
        alt="major" />
      <div
        class="card-body d-flex flex-column gap-1 justify-content-center">
...
<div class="banner container d-block d-lg-grid d-md-block d-sm-block">
  <div class="info">
    <div class="info__details">
      <img
        ...
        width="50"
        height="50" />
      <h4 class="title m-0">everything you need is found at VCare.</h4>
      <p class="content">
        search for a doctor and book an appointment in a hospital, clinic,
        home visit or even by phone, you can also order medicine or book a
        surgery.
      </p>
    </div>
  </div>
  ...
  <div class="bottom--left bottom--content bg-blue text-white">
    ...
    <p>
      ...
      facere eveniet in id, quod explicabo minus ut, sint possimus, fuga
      voluptas. Eius molestias eveniet labore ullam magnam sequi possimus
      quaerat!
    </p>
    <div class="app-group">
      <div class="app">
